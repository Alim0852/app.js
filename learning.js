...
var email = "alimughalalimughal0852@gmail.com"
alert("Email = "+ email)

var PhoneNum = "0310 7685980"
...
alert("Assalam o alaikum! M.Alim here from SMIT Batch 11 Web dev trainer sir nadir !")
...
var date = new Date("May 26, 2024 12:30");
...
switch(user){
    case "Alim":
        console.log('Welcome Mr.Alim')
        break;
    case "mohsin":
        console.log('Greetings Mr.mohsin')
        break;
    case "Bilal":
